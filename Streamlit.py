...
import os
print(os.path.exists(r"D:\Data science\Cricsheet_Match_Analysis\isrgrootx1.pem"))
...
def db_config():
    return {
        ...
        'port': 4000,
        'user': '45zomgjzrEaJ3az.root',
        'password': 'pL7yBHrDIMx652G0',
        'database': 'cricsheet',
        'ssl_ca' : 'True',
        'connect_timeout': 30
        }
...
# Load CSVs correctly
def load_csv_in_chunks(file_path, chunk_size=10000, match_type=None):
    import pandas as pd
    chunks = []
...
# Use the function for all CSVs
df_ipl = load_csv_in_chunks(r"D:\Data science\Cricsheet_Match_Analysis\IPL.csv", chunk_size=10000, match_type="IPL")
df_test = load_csv_in_chunks(r"D:\Data science\Cricsheet_Match_Analysis\Test.csv", chunk_size=10000, match_type="Test")
df_odi = load_csv_in_chunks(r"D:\Data science\Cricsheet_Match_Analysis\ODI.csv", chunk_size=10000, match_type="ODI")
df_t20 = load_csv_in_chunks(r"D:\Data science\Cricsheet_Match_Analysis\T20.csv", chunk_size=10000, match_type="T20")
